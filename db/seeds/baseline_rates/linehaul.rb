class Linehaul
  def self.parse(sheet, daterange)
    ...
    conus_rates = flatten_linehaul_rates(4, 57, 5, 98, 6000)
    intra_ak_rates = flatten_linehaul_rates(63, 88, 5, 98, 2000)
  ...
  def self.flatten_linehaul_rates(firstRow, lastRow, firstColumn, lastColumn, maxDistance)
    output = Array.new
